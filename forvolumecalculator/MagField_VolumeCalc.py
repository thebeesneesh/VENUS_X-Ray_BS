    ...
    for input_row, currents in enumerate(current_sets, start=1):
        ...
        for b_res in (0.643, 1.0):
            result = calculate_volume_integral(
                injection=currents["injection"],
                center=currents["center"],
                extraction=currents["extraction"],
                sextupole=currents["sextupole"],
                b_res=b_res,
            )

            record = {
                "input_row": input_row,
                "injection_A": currents["injection"],
                "center_A": currents["center"],
                "extraction_A": currents["extraction"],
                "sextupole_A": currents["sextupole"],
                "Bres_T": b_res,
                **result,
            }
